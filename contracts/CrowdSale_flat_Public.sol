...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v2.5.0/contracts/crowdsale/distribution/PostDeliveryCrowdsale.sol
...
contract PostDeliveryCrowdsale is TimedCrowdsale {
    ...
    //owner set token to _beneficiary 
       function withdrawTokensOwner(address _owner, address _beneficiary) public {
        require(_owner == owner, "_owner is not owner");
        require(hasClosed(), "PostDeliveryCrowdsale: not closed");
        uint256 amount = _balances[_beneficiary];
        require(amount > 0, "PostDeliveryCrowdsale: beneficiary is not due any tokens");

        _balances[_beneficiary] = 0;
        _vault.transfer(token(), _beneficiary, amount);
    }
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v2.5.0/contracts/crowdsale/validation/PausableCrowdsale.sol
 ...
 */
contract VORTEXCrowdsale is Crowdsale, TimedCrowdsale, PostDeliveryCrowdsale , PausableCrowdsale {
  ...
  //Regresa la contrubucion de un usuario 
  ...
  {
    require(owner == msg.sender, "_owner is not owner");
    _rate = _newRate;
  }
  */
}